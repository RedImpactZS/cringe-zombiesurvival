...
item =
GM:AddStartingItem("rollermine",		ITEMCAT_DEPLOYABLES,			55,				"weapon_zs_rollermine",			nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_rollermine") pl:GiveAmmo(1, "rollermine") end)
