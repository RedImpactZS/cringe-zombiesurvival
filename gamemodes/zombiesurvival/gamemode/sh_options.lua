...
-- Tier 6
GM:AddPointShopItem("zeus",		        ITEMCAT_GUNS,			300,			"weapon_zs_zeus")
GM:AddPointShopItem("colossus",			ITEMCAT_GUNS,			300,			"weapon_zs_colossus")
GM:AddPointShopItem("bulwark",			ITEMCAT_GUNS,			300,			"weapon_zs_bulwark")
GM:AddPointShopItem("juggernaut",		ITEMCAT_GUNS,			300,			"weapon_zs_juggernaut")
GM:AddPointShopItem("deathdlrs",		ITEMCAT_GUNS,			300,			"weapon_zs_deathdealers")
GM:AddPointShopItem("spinfusor",		ITEMCAT_GUNS,			300,			"weapon_zs_spinfusor")
GM:AddPointShopItem("gluon",			ITEMCAT_GUNS,			300,			"weapon_zs_gluon")
GM:AddPointShopItem("interceptor",		ITEMCAT_GUNS,		        300,		        "weapon_zs_interceptor")
GM:AddPointShopItem("hephaestus",		ITEMCAT_GUNS,		        300,		        "weapon_zs_hephaestus")
