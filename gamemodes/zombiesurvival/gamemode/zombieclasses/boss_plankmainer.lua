...
CLASS.Name = "The Plank Mainer"
CLASS.TranslationName = "class_plankmainer"
CLASS.Description = "description_plankmainer"
CLASS.Help = "controls_plankmainer"
...
CLASS.SWEP = "weapon_zs_plank"

if SERVER then
	function CLASS:OnSpawned(pl)
		pl:CreateAmbience("plankmainerambience")
	end
end
