CLASS.Name = "Giga Gore Child With Gun"
CLASS.TranslationName = "class_giga_gore_child_with_gun"
CLASS.Description = "description_giga_gore_child_with_gun"
CLASS.Help = "controls_giga_gore_child_with_gun"
