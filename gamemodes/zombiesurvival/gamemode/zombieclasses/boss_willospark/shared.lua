CLASS.Name = "Wil O' SPARK"
CLASS.TranslationName = "class_wilospark"
CLASS.Description = "description_wilospark"
CLASS.Help = "controls_wilospark"
...
CLASS.SWEP = "weapon_zs_willospark"
