...
SWEP.VElements = {
	...
	["1"] = { type = "Model", model = "models/kleiner.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "main", pos = Vector(0, 0, -1.5), angle = Angle(0, 0, 0), size = Vector(0.029, 0.029, 0.029), color = Color(166, 200, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.WElements = {
	...
	["1"] = { type = "Model", model = "models/kleiner.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "main", pos = Vector(0, 0, -1.5), angle = Angle(0, 0, 0), size = Vector(0.029, 0.029, 0.029), color = Color(166, 200, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
