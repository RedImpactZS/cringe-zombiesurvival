...
SWEP.Primary.Ammo = "childgrenade"
SWEP.Primary.Delay = 1.25
SWEP.Primary.DefaultClip = 1
SWEP.Primary.Sound = Sound("ambient/creatures/town_child_scream1.wav")
...
function SWEP:Initialize()
	self:SetWeaponHoldType("childgrenade")
